...
// Importing useActionState from react to handle the form action.
import { useActionState } from 'react';

export default function Form({ customers }: { customers: CustomerField[] }) {
  // 初始状态，message 为 null，errors 为空对象。
  const initialState: State = { message: null, errors: {} };

  // 参数 createInvoice 是处理表单动作的函数，initialState 是初始状态。
  // 返回值 state 是状态，formAction 是处理表单动作的函数。
  // 状态 state 包含错误信息和消息。
  // 处理表单动作的函数 formAction 用于处理表单动作。
